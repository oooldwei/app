        ...
        body: Column(
          children: [
            ElevatedButton(
              child: Text("刷新数据"),
              onPressed: () =>
                  controller.getVideInfo(controller.state.bvid.value),
            ),
            ElevatedButton(
              onPressed:
              ...
              child: controller.state.webInterfaceView.value.pages != null
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          title: controller.state.playingIndex.value == index
                              ? Text(
                                  "播放: ${controller.state.webInterfaceView.value.pages![index].part!}")
                              : Text(controller.state.webInterfaceView.value
                                  .pages![index].part!),
                          subtitle: Text(
